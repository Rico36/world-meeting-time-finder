...
def render_pair_page(city_a, city_b, all_cities):
    ...
    body = (
        ...
        f'    <section><h2>Best time to meet</h2>{meeting_section}'
        f'<a class="primary-button" href="{esc(meeting_url(city_a, city_b))}">'
        f'Check another date for {esc(name_a)} and {esc(name_b)}</a></section>\n'
